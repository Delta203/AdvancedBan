  ...
  public void connect() {
    ...
    try {
      ...
      ProxyServer.getInstance()
          ...
          .sendMessage(
              new TextComponent(
                  AdvancedBan.prefix + AdvancedBan.messages.getString("mysql.connected")));
  ...
  public void createTable() {
    try {
      connection
          .prepareStatement(
              "CREATE TABLE IF NOT EXISTS AB_PlayerInfo (PlayerUUID VARCHAR(100), PlayerName VARCHAR(100), "
                  + "Server VARCHAR(100), LoginKey VARCHAR(100))")
          .executeUpdate();
      connection
          .prepareStatement(
      ...
      ProxyServer.getInstance()
          ...
          .sendMessage(
              new TextComponent(
                  AdvancedBan.prefix + AdvancedBan.messages.getString("mysql.tables")));
    } catch (SQLException e) {
      e.printStackTrace();
    }
  }
